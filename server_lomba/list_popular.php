...
WHERE tb_wisata.id_kota_kabupaten= tb_kota_kabupaten.id_kota_kabupaten && tb_wisata.id_kategori_wisata= tb_kategori_wisata.id_kategori_wisata ORDER BY popular_wisata DESC LIMIT 2";
