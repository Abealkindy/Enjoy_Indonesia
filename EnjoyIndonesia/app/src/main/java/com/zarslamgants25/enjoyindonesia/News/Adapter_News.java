...
import com.zarslamgants25.enjoyindonesia.Databases.GSONnews;
...
/**
 * Created by KOCHOR on 4/26/2017.
 */
...
class Adapter_News extends RecyclerView.Adapter <Adapter_News.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_list__news, parent , false);
